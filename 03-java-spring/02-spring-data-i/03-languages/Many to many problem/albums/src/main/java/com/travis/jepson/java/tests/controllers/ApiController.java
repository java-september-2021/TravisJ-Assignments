...
// THIS IS MORE IN LINE FOR REFERENCING THE DATA, CALLING IT AND ALTERING ETC
// ON BACKEND  for front end use => HomeController.java
//
// Create a new CLASS for this file
//
//
// The RestController makes this an API
// THIS WAS RENAMED to ApiController through
...
//
// ADD A PREFIX in URL
// THIS ADDS TO EVERY SINGLE ENDPOINT
